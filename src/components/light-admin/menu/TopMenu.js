    ...
    return (
        <div className="logged-user-w avatar-inline">
          <div className="logged-user-i">
            <div className="avatar-w" style={{border: 'none'}}><i className='pre-icon os-icon os-icon-user-male-circle' /></div>
            <div className="logged-user-info-w">
              <div className="logged-user-name">{this.props.user.email ? this.props.user.email : ''}</div>
              <div className="logged-user-role" style={{color: '#cdcdcd'}}>{this.props.user.groups ? this.props.user.groups[0].displayName : ''}</div>
            </div>
            ...
            <div className="logged-user-menu">
              ...
              <div className="logged-user-avatar-info">
                <div className="avatar-w"><i className='pre-icon os-icon os-icon-user-male-circle' /></div>
                <div className="logged-user-info-w">
                  <div className="logged-user-name">{this.props.user.email ? this.props.user.email : ''}</div>
