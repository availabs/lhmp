...
export default class DraggableModal extends React.Component {
    ...
    render() {
        ...
        return (
            <DraggableContainer style={ { left, top, width, height, display: this.props.show ? "block" : "none" } }
                ...
                <DragHandle innerRef={ comp => this.dragHandle = comp }
                            style={ { cursor: this.state.dragging ? "grabbing" : "grab" } }>
                    <VertDots height="26px"/>
                </DragHandle>

                <ResizeHandle innerRef={ comp => this.resizeHandle = comp }
