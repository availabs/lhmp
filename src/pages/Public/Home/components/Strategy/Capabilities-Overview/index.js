...
class CapabilitiesOverview extends Component {
        ...
        return (
            <PageContainer> 
                <HeaderContainer style={{}}>
                    <PageHeader>Capabilities Overview</PageHeader>
                        <br/>
                        <ContentContainer>
                            <SectionBox>
                                ...
                                <SectionBoxMain>
                                    <RenderConfig
                                        config={{'Capabilities Overview':config['Capabilities Overview']}}
...
export default connect(mapStateToProps, mapDispatchToProps)(reduxFalcor(CapabilitiesOverview))
