    ...
    elements: [
        ...
        },
        {
            ...
            requirements_from_software:
                ...
                'req-B1-riverine, req-B1-hurricane, req-B1-tornado, req-B1-landslide, req-B1-wind, req-B1-wildfire,' +
                'req-B1-tsunami, req-B1-lightning, req-B1-icestorm, req-B1-coastal, req-B1-heatwave, req-B1-hail,' +
                'req-B1-earthquake, req-B1-draught, req-B1-avalanche, req-B1-coldwave, req-B1-winterweat, req-B1-volcano,',
