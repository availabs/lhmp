...
module.exports = [
    ...
    {value : '200', name : 'Resvalueential'},
    {value : '210', name : 'One family year-round resvalueence'},
    {value : '215',name : 'One family year-round resvalueence with accessory apartment'},
    {value : '220', name : 'Two family year around resvalueence'},
    {value : '230', name : 'Three family year around resvalueence'},
    {value : '240', name : 'Rural resvalueence with Acreage'},
    {value : '241',name : 'Primary resvalueential,also used in agricultural production'},
    {value : '242',name : 'Recreational use'},
    {value : '250', name : 'Estate'},
    {value : '260', name : 'Seasonal Resvalueences'},
    {value : '270', name : 'Mobile home'},
    {value : '271',name : 'Multiple mobile homes'},
    {value : '280', name : 'Resvalueential - Multi-Purpose/Multi-Structure'},
    {value : '281',name : 'Multiple resvalueences'},
    {value : '283',name : 'Resvalueence with Incvalueental commercial use'}  ,
    {value : '300', name : 'Vacant land'},
    {value : '310', name : 'Resvalueential'},
    {value : '311', name :'Resvalueential Vacant land'},
    {value : '312', name :'Resvalueential land including a small improvement(not used for living accommodation)'},
    ...
    {value : '322',name : 'Resvalueential vacant land over 10 acres'},
    ...
    {value : '692',name : 'Roads,Streets,Highways and parkways, Express or otherwise(if included) including adjoining land'},
    ...
    {value : '931',name : 'State Owned Land (Forest Preserve) in the Adirondack or Catskill Parks Taxable Under Section 532-a of the Real Property Tax Law'},
    {value : '932',name : 'State Owned Land Other Than Forest Preserve Covered Under Section 532-b, c, d, e, f, or g of the Real Property Tax Law'},
    ...
    {value : '971',name : 'Wetlands, Either Privately or Governmentally Owned, Subject to Specific Restrictions as to Use'},
    {value : '972',name : 'Land Under Water, Either Privately or Governmentally Owned (other than resvalueential - more properly classified as value 315)'},
...
module.exports = [
    ...
    children:[
        {
            value: '105',
            name: 'Agricultural Vacant Land (Productive)',
            children: []
        },
        {
            value: '110',
            name: 'Livestock and Products',
            children: [
                {value: '111', name: 'Poultry and Poultry Products: eggs, chickens, turkeys, ducks and geese'},
                {value: '112', name: 'Dairy Products : Milk, butter and cheese'},
                {value: '113', name: 'Cattle, Calves and hogs'},
        ...
        {
            value: '130',
            name: 'Truck Crops - Mucklands'
        },
        {
            value: '140',
            name: 'Truck crops - Not mucklands'
        },
        {
            value: '150',
            name: 'Orchard crops',
        ...
        {
            value: '170',
            name: 'Nursery and greenhouse'
        },
        {
            value: '180',
            name: 'Speciality farms',
            children: [
                {value: '181', name: 'Fur Products:mink,chinchilla,etc'},
                {value: '182', name: 'Pheasant etc'},
                {value: '183', name: 'Aquatic: oysterlands,fish and aquatic plants'},
        ...
        {
            value: '190',
            name: 'Fish,game and wildlife preserves'
        }
        ],
    },
    ...
    children : [
        {
            value : '210',
            name : 'One family year-round resvalueence',
            children : [
                {value : '215',name : 'One family year-round resvalueence with accessory apartment'}
            ]
        },
        {
            value : '220',
            name : 'Two family year around resvalueence'
        },
        {
            value : '230',
            name : 'Three family year around resvalueence'
        },
        {
            value : '240',
            name : 'Rural resvalueence with Acreage',
            children : [
                {value : '241',name : 'Primary resvalueential,also used in agricultural production'},
                {value : '242',name : 'Recreational use'}
            ]
        ...
        {
            value : '280',
            name : 'Resvalueential - Multi-Purpose/Multi-Structure',
            children : [
                {value : '281',name : 'Multiple resvalueences'},
                {value : '283',name : 'Resvalueence with Incvalueental commercial use'}
            ]
    ...
    children : [
        ...
        {
            value : '340',
            name : 'Vacant land located in Industrial areas',
            children : [
                {value : '341',name : 'Industrial vacant land with minor improvements'}
            ]
        },
        {
            value : '350',
            name : 'Urban renewal or slum clearance',
            children : [
                {value : '351',name : 'Shell building - resvalueential'},
                {value : '352',name : 'Shell building - commercial'}
            ]
        ...
        {
            value : '380',
            name : 'Public utility vacant land'
        }
    ]
    },
    {
    ...
    children : [
        ...
        {
            value : '440',
            name : 'Storage, warehouse and Distribution facilities',
            children : [
                {value : '441',name : 'Fuel Storage and distribution facilities'},
                {value : '442',name : 'Mini warehouse(self storage'},
                {value : '443',name : 'Grain and feed elevators,Mixers,Sales outlets'},
        ...
        {
            value : '460',
            name : 'Banks and Office buildings',
            children : [
                {value : '461',name : 'Standard Bank/Single occupant'},
                {value : '462',name : 'Drive-in branch bank'},
                {value : '463',name : 'Bank complex with office building'},
        ...
        {
            value : '480',
            name : 'Multiple use or Multi-purpose',
            children : [
                {value : '481',name : 'Downtown row Type(with common wall)'},
                {value : '482',name : 'Downtown row type(detached)'},
                {value : '483',name : 'converted resvalueence'},
    ...
    children : [
        ...
        {
            value : '580',
            name : 'Camps,Camping Facilities and resorts',
            children : [
                {value : '581',name : 'camps'},
                {value : '582',name : 'Camping Facilities'},
                {value : '583',name : 'Resort complexes'},
    ...
    children : [
        ...
        {
            value : '680',
            name : 'Cultural and Recreational',
            children : [
                {value : '681',name : 'Cultural facilities'},
                {value : '682',name : 'Recreational facilities'}
            ]
    ...
    children : [
        ...
        {
            value : '740',
            name : 'Industrial Product pipelines',
            children : [
                {value : '741',name : 'Gas'},
                {value : '742',name : 'Water'},
                {value : '743',name : 'Brine'},
    ...
    children : [
        ...
        {
            value : '860',
            name : 'Special Franchise property',
            children : [
                {value : '861',name : 'Electric and gas'},
                {value : '862',name : 'Water'},
                {value : '866',name : 'Telephone'},
        ...
        {
        value : '880',
        name : 'Electric and Gas Transmission and distribution',
        children : [
            {value : '882',name : 'Electric transmission improvement'},
            {value : '883',name : 'Gas transmission improvement'},
            {value : '884',name : 'Electric distribution-Outsvaluee plant property'},
    ...
    {
    value : '900',
    name : 'Wild Forested Conservation lands and public parks',
    children : [
        {
            value : '910',
            name : 'Private Wild and Forest Lands except for Private Hunting and Fishing Clubs',
            children : [
                {value : '911',name : 'Forest Land Under Section 480 of the Real Property Tax Law'},
                {value : '912',name : 'Forest Land Under Section 480-a of the Real Property Tax Law'},
            ]
        ...
        {
            value : '920',
            name : 'Private Hunting and Fishing Clubs'
        },
        {
            value : '930',
            name : 'State Owned Forest Lands',
            children : [
                {value : '931',name : 'State Owned Land (Forest Preserve) in the Adirondack or Catskill Parks Taxable Under Section 532-a of the Real Property Tax Law'},
                {value : '932',name : 'State Owned Land Other Than Forest Preserve Covered Under Section 532-b, c, d, e, f, or g of the Real Property Tax Law'}
            ]
        ...
        {
            value : '940',
            name : 'Reforested Land and Other Related Conservation Purposes',
            children : [
                {value : '941',name : 'State Owned Reforested Land Taxable Under Sections 534 and 536 of the Real Property Tax Law'},
                {value : '942',name : 'County Owned Reforested Land'}
            ]
        ...
        {
            value : '950',
            name : 'Hudson River and Black River Regulating District Land'
        },
        {
            value : '960',
            name : 'Public Parks',
        ...
        {
            value : '970',
            name : 'Other Wild or Conservation Lands',
            children : [
                {value : '971',name : 'Wetlands, Either Privately or Governmentally Owned, Subject to Specific Restrictions as to Use'},
                {value : '972',name : 'Land Under Water, Either Privately or Governmentally Owned (other than resvalueential - more properly classified as value 315)'}
            ]
        ...
        {
            value : '980',
            name : 'Taxable State Owned Conservation Easements'
        },
        {
            value : '990',
            name : 'Other Taxable State Land Assessments',
            children : [
                {value : '991',name : 'Adirondack Park Aggregate Additional Assessments (Real Property Tax Law, Section 542(3))'},
                {value : '992',name : 'Hudson River-Black River Regulating District Aggregate Additional Assessments (Environmental Conservation Law, Section 15-2115)'},
                {value : '993',name : 'Transition Assessments for Taxable State Owned Land (Real Property Tax Law, Section 545)'},
