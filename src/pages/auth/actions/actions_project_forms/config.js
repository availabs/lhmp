module.exports = [
    {
        ...
        attributes: {
            ...
            associated_hazards: {
                ...
                meta_filter: {
                    filter_key: '',
                    value: ['Select All', 'Select None', 'Avalanche', 'Coastal Hazards', 'Coldwave', 'Drought',
                    ...
                    groupName: {
                        'All Hazards': ['Avalanche', 'Coastal Hazards', 'Coldwave', 'Drought',
                            'Earthquake', 'Hail', 'Heat Wave', 'Hurricane', 'Ice Storm', 'Landslide', 'Lightning',
                            'Flooding', 'Tornado', 'Tsunami/Seiche', 'Volcano', 'Wildfire', 'Wind', 'Snow Storm'],
                        'Some Hazards': ['Avalanche', 'Coastal Hazards', 'Coldwave', 'Drought']
                    }
                }, // only used when metaSource is not meta_file
                section: '1'
            },
            action_description: {
