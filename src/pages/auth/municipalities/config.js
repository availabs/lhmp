module.exports = [
    {
        ...
        attributes: {
            ...
            csc_level:{
                label:'What is the certification level of climate smart community?',
            ...
            crs_community_number:{
                label:'Community Rating System Number',
                prompt:'',
                sub_type:'',
                edit_type:'text',
                display_type:'text',
            ...
            current_effective_date:{
                ...
                prompt:'Provide the date of the CRS map currently in effect.',
                sub_type:'',
                edit_type:'text',
                display_type:'text',
                meta:'false',
            ...
            status:{
                label:'Status of CSC',
                prompt:'Identify the current status of the community. Either current or rescinded',
                sub_type:'',
                edit_type:'',
                display_type:'',
                meta:'',
            ...
            current_nfip_ordinance:{
                label:'NFIP Ordinance',
                prompt:'Identify the current NFIP ordinance for the municipality.',
                sub_type:'',
                edit_type:'',
                display_type:'',
                meta:'',
