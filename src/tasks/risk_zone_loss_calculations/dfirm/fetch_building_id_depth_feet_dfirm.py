...
def createTable(cursor):
    ...
    results.to_csv("/home/nayanika/IdeaProjects/mitigate-api/tasks/risk_zone_loss_calculations/dfirm/building_id_depth_feet.csv", index=False,header= ['building_id','risk_value'])
