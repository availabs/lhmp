...
def createTable(cursor):
    ...
    results.to_csv("/home/nayanika/IdeaProjects/mitigate-api/tasks/risk_zone_loss_calculations/dfirm/building_risk_data.csv", index=False,header= ['building_id','risk_value','building_type','replacement_value','hazard_loss_percent','hazard_loss_dollars'])
